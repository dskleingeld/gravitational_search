...
\begin{figure}
	...
	\subcaptionbox{Implementation in GSA paper, in black the performance of GSA}
...
\begin{figure}
	\centering
	\subcaptionbox{My GABSA implementation \label{fig:myf1}}
		[.49\linewidth]{\includegraphics{gabsa/f1_gabsa}}
	\subcaptionbox{The original GABSA implementation \label{fig:bad1}}
...
\begin{figure}
	\centering
	\subcaptionbox{My GABSA implementation}
		[.49\linewidth]{\includegraphics{gabsa/f3_gabsa}}
	\subcaptionbox{The original GABSA implementation \label{fig:bad2}}
